...
using DatastructureAndAlgo_Practice.Leetcode_questions;
...
internal class ProgramHelpers
{
	...
	public IRunProgram GetInstance()
	{
...
");
	...
	private static void PrintMessage(object sender, string message)
	{
